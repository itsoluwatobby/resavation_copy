...
const valueClass =
  "flex-auto flex text-xs mobile:text-sm items-end justify-end w-[15%] mobile:w-[25%] text-gray-600 font-normal capitalize";

const attributeClass =
  "flex-auto w-[40%] flex items-start  font-normal text-left capitalize";

export const ApartmentAcceptDecline = ({}) => {
  return (
    <div className="flex flex-col w-full gap-1 mobile:text-sm">
      ...
      <div className="flex items-center justify-center gap-5">
        <button className="bg-blue-700 hover:bg-blue-600 active:bg-blue-700 px-5 py-2 text-xs transition-all text-white  rounded-md cursor-pointer w-fit">
          Accept
        </button>
        <button className="bg-gray-300 hover:bg-blue-600  px-5 py-2  text-xs transition-all text-black   rounded-md cursor-pointer w-fit">
          Cancel
        </button>
      </div>
    </div>
