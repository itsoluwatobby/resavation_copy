...
export const ApartmentSentMakePayment = ({}) => {
  return (
    <div className="flex flex-col w-full gap-1 mobile:text-sm">
      ...
      <div className="flex items-center justify-center gap-5">
        <button className="bg-blue-700 hover:bg-blue-600 active:bg-blue-700 px-[3rem] py-[.7rem] text-xs transition-all text-white  rounded-md cursor-pointer w-fit">
          Accept Payment
        </button>
      </div>
    </div>
